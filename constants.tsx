...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    id: '12',
    name: '생생 프리미엄 유산균',
    images: ['https://picsum.photos/seed/probi/300/300'],
    price: 30000,
    storage: '냉장',
    usage: '1일 1회 1캡슐 공복',
    isActive: true,
    expirationDate: '2026-12-31',
    pillType: 'capsule-brown',
    ingredients: [{ name: '프로바이오틱스', amount: 100, unit: '억CFU' }]
  }
];
...
1. 수집 항목: 성명, 연락처, 주소, 이메일, 연령대, 임신 단계, 혈액검사 결과(비타민D, Hb), 건강 상태 및 증상 등
2. 수집 목적: 맞춤형 영양제 상담, 제품 추천, 소분 판매 기록 관리(법정 3년 보관), 이메일을 통한 상담 결과지 및 영양 정보 발송
3. 보유 및 이용 기간: 상담 및 판매일로부터 3년 (법령 및 운영 정책에 따른 보관 의무 준수)
4. 동의 거부 권리: 귀하는 동의를 거부할 권리가 있으나, 거부 시 개인 맞춤형 상담 서비스 이용이 제한될 수 있습니다.

본인은 위와 같은 개인정보 및 민감정보(건강정보 등) 수집·이용에 동의하며, 상담 결과 및 제품 상세 내역을 이메일로 수신함에 동의합니다.`;
